// BluetoothWindow.qml - layer-shell window hosting the Liquid Glass Bluetooth
// menu.
//
...
//     visibility toggle
//   - blur is provided by Hyprland via the `quickshell:bluetooth` namespace
//     layerrule (see hyprland.conf)
