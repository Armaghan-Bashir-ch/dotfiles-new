...
yay -S --noconfirm go wakafetch-git spotify python nodejs networkmanager tty-clock crush oh-my-zsh zen-browser-bin wlogout-git bibata-cursor-themes nerd-fonts-cascadia-code nerd-fonts-jetbrains-mono swayosd less crontab spicetify-cli spicetify-themes-git tokyonight-gtk-theme github-cli bibata-cursor-themes ttf-font-awesome
